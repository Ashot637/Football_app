  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.p}>
            <Text style={styles.boldText}>1. {t("privacy_policy.p1").split(":")[0]}:</Text>
            {t("privacy_policy.p1").split(":")[1]}
          </Text>

          <Text style={styles.p}>
            <Text style={styles.boldText}>2. {t("privacy_policy.p2").split(":")[0]}:</Text>
            {t("privacy_policy.p2").split(":")[1]}
          </Text>

          <Text style={styles.p}>
            <Text style={styles.boldText}>3. {t("privacy_policy.p3").split(":")[0]}:</Text>
            {t("privacy_policy.p3").split(":")[1]}
          </Text>

          <Text style={styles.p}>
            <Text style={styles.boldText}>4. {t("privacy_policy.p4").split(":")[0]}:</Text>
    ...
    <View style={styles.p3Container}>
          ...
          <View style={styles.p3Container}>
          <Text style={styles.p3Item}>1. {t("privacy_policy.title4-p1")}</Text>
          <Text style={styles.p3Item}>2. {t("privacy_policy.title4-p2")}</Text>
          <Text style={styles.p3Item}>3. {t("privacy_policy.title4-p3")}</Text>
          </View>
          ...
          <Text style={styles.p}>{t("privacy_policy.title7-item")}
          ...
          <Text style={styles.p}>{t("privacy_policy.title9-item")}
          <TouchableOpacity onPress={handlePress}>
                  <Text style={styles.link}>contact@ballhola.app</Text>
                </TouchableOpacity>
          </Text>
